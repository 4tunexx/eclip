    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-4 rounded-2xl border border-white/10 bg-black/50 p-5">
        ...
        <p className="text-xs text-neutral-400">
          Login with email or continue with Steam. Email verification is required to play.
        </p>
        ...
        <button className="w-full rounded-md border border-[#1B2838] bg-[#1B2838] px-3 py-2 text-xs font-semibold text-[#C7D5E0]">
          Continue with Steam
        </button>
      </div>
    </div>
